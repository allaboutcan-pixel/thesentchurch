    ...
    ko: {
        translation: {
            ...
            "home": {
                ...
                "quick_morning_sub": "Early Morning Service",
                "quick_morning_desc1": "매달 첫째, 둘째 주",
                "quick_morning_desc2": "새벽 6:00 온라인 줌",
                "quick_bulletin_link": "주보 보기",
                ...
                "past_gallery": "지난 갤러리 아카이브",
                "past_gallery_desc": "교회의 은혜로운 순간들을 다시 돌아보는 사진 및 영상 보관함입니다.",
            ...
            "ministry": {
                ...
                "learn_more": "자세히 보기",
                "fold": "접기",
                "sunday_school_title": "다음 세대",
                "sunday_school_description": "우리 Sunday School은 아이들이 말씀 안에서 성장하며,\n믿음과 충성으로 하나님을 섬기는 제자로 자라도록 돕습니다.",
                "sunday_school_desc_mobile": "우리 Sunday School은 아이들이 말씀 안에서<br/>성장하며, 믿음과 충성으로 하나님을 섬기는<br/>제자로 자라도록 돕습니다.",
                "sunday_school_subtitle": "마땅히 행할 길을 아이에게 가르치라 그리하면 늙어도 그것을 떠나지 아니하리라(잠 22:6)",
                "sunday_school_subtitle_mobile": "마땅히 행할 길을 아이에게 가르치라<br/>그리하면 늙어도 그것을 떠나지 아니하리라<br/>(잠 22:6)",
                ...
                "prayer": {
                    ...
                    "section4_title": "운영시간",
                    "common_topics": [
                        "말씀을 준비하는 담임목사님께 성령의 충만함을 주셔서 은혜의 말씀을 준비하고 생명력있는 말씀을 전하게 하여 주옵소서.",
                        "예배를 준비하는 모든 성도님들에게 한량없는 은혜를 부어 주셔서 담당하는 사역에 감사와 기쁨이 넘치게 하시고 풍성한 열매들을 맺게 하여 주옵소서.",
                        "하나님께 나아가는 것을 방해하는 악한 영으로부터 모든 성도님들의 가정을 보호하여 주셔서 당당하게 하나님께로 가까이 나아와 승리하게 하여 주옵소서."
                    ],
                    "pastor_topics": ["건강과 가족", "영적 분별력", "효과적인 리더십"],
                    "church_topics": [
                        "“사도행전의 교회가 되게 하소서”",
                        "하나님의 사랑과 은혜, 축복이 강물처럼 넘쳐흐르는 교회 : 예배때마다 성령의 충만으로 온 성도가 하나님의 사랑과 은혜를 체험하는 교회. 성도들의 삶속에 하나님의 축복이 임하여 서로의 필요를 따라 베풀고 나누는 교회.",
                        "모든 성도들이 성령에 붙잡혀 존귀하게 쓰임받는 교회 : 모든 성도들이 가정, 학교, 일터에서 하나님의 전능하심 선하심을 증거하여 하나님의 함께 하심이 소문 나는 교회. 그리하여 그 은혜를 갈망하는 자들이 몰려와 매 주일마다 구원받는 자들이 더해지는 교회.",
                        "믿음의 명문가를 세우는 교회 : 모든 성도들의 가정이 믿음 위에 굳건히 세워지고, 다음 세대에게 믿음의 유산을 남기며, 삶의 현장에서 복음의 영향력을 행사하는 신앙의 인물들을 세우는 교회."
                    ],
            ...
            "tee": {
                ...
                "intro_desc_mobile": "TEE는 <span class='text-blue-600 font-bold'>Theological Education by Extension</span>의<br/>약자로, 디모데후서 2장 2절 말씀에 기초한<br/>“확장에 의한 신학 교육”입니다.<br/><br/>성경 공부와 제자 양육을 통해<br/>신앙이 다음 세대로 이어지도록 돕는,<br/>검증된 훈련 방법입니다.",
                "intro_subdesc_mobile": "현재 TEE는 전 세계 110여 개국에서<br/>70여 개 언어로 사용되며,<br/>수많은 교회가 평신도 양육과<br/>지도자 훈련을 위해 활용하고 있습니다.",
                ...
                "core_goal_desc": "한 사람의 제자가 또 다른 제자를 세우는<br/>영적 재생산입니다.<br/>소그룹 중심의 훈련을 통해 성도들을<br/>영적으로 세우고, 교회의 다음 세대<br/>지도자로 성장하도록 돕습니다.<br/><br/>처음에는 느리고 작게 시작되지만,<br/>복음과 제자가 함께 확산될 때<br/>놀라운 영향력과 열매를 맺게 됩니다.",
                "core_goal_desc_mobile": "한 사람의 제자가 또 다른 제자를 세우는 <strong>영적 재생산</strong>입니다.<br/>소그룹 중심의 훈련을 통해 성도들을 영적으로 세우고,<br/>교회의 다음 세대 지도자로 성장하도록 돕습니다.<br/><br/>처음에는 느리고 작게 시작되지만,<br/>복음과 제자가 함께 확산될 때<br/>놀라운 영향력과 열매를 맺게 됩니다.",
                ...
                "fruits_desc": "TEE를 통해 모든 성도들이 하나님의 말씀 위에 굳게 뿌리내리고,<br/>믿음과 영적 성숙 안에서 자라가기를 기도합니다.<br/>소그룹 공동체 안에서 서로를 세워가며,<br/>또 다른 제자를 세우는 건강한 교회로 세워지기를 소망합니다.<br/><br/>이 여정을 통해 우리 교회가 말씀으로 삶이 견고해지고,<br/>그리스도 안에서 관계가 더욱 깊어지며,<br/>제자가 끊임없이 세워지는 생동감 있는<br/>공동체로 계속해서 성장해 가기를 바랍니다.",
                "fruits_desc_mobile": "TEE를 통해 모든 성도들이<br/>하나님의 말씀 위에 굳게 뿌리내리고,<br/>믿음과 영적 성숙 안에서<br/>자라가기를 기도합니다.<br/>소그룹 공동체 안에서 서로를 세워가며,<br/>또 다른 제자를 세우는<br/>건강한 교회로 세워지기를 소망합니다.<br/><br/>이 여정을 통해 우리 교회가<br/>말씀으로 삶이 견고해지고,<br/>그리스도 안에서 관계가 더욱 깊어지며,<br/>제자가 끊임없이 세워지는<br/>생동감 있는 공동체로<br/>계속해서 성장해 가기를 바랍니다.",
            },
            "team_ministry": {
                "title": "팀사역",
                "subtitle": "함께 섬기는 기쁨",
            ...
            "bible": {
                ...
                "intro_desc_mobile": "요한복음 한 권을 문맥과 흐름에 따라<br/>깊이 있게 살펴봅니다.<br/>성경 자체가 교재가 되어 말씀을 깊이 만나고,<br/>신앙의 기초를 견고히 세워가는 말씀의 여정",
                ...
                "theo_diff_text1_mobile": "공관복음 (마태, 마가, 누가) 은 우리에게 예수님이 '무엇을<br/>하셨고 어떤 말씀을 하셨는지'를 생생하게 증언해 줍니다.<br/>하지만 요한복음은 거기서 한 걸음 더 나아가, 그분이<br/>'진정 누구이신지' 그리고 '그분의 죽음과 부활이 우리에게<br/>어떤 영적 의미가 있는지'를 깊이 있게 풀어내고 있습니다.",
                "theo_diff_text2": "그래서 공관복음이 예수님의 삶과 발자취를 있는 그대로 비추는 '기록용 렌즈'라면, 요한복음은 그분의 존재가 지닌 본질과 신비로운 의미를 조명하는 '현미경 렌즈'와 같습니다.",
                "theo_diff_text2_mobile": "그래서 공관복음이 예수님의 삶과 발자취를<br/>있는 그대로 비추는 '기록용 렌즈'라면, 요한복음은<br/>그분의 존재가 지닌 본질과 신비로운 의미를 조명하는<br/>'현미경 렌즈'와 같습니다.",
                "theo_diff_text3": "전자가 역사의 현장을 중계한다면, 후자는 그 이면에 담긴 신학적 진리를 설파합니다.",
                "theo_diff_text3_mobile": "전자가 역사의 현장을 중계한다면,<br/>후자는 그 이면에 담긴 신학적 진리를 설파합니다.",
    ...
    en: {
        translation: {
            "nav": {
                ...
                "pastor": "Senior Pastor's Greeting",
                "staff": "Our Staff",
                "location": "Location",
                "worship": "Worship",
            ...
            "home": {
                ...
                "media_title": "Word & Worship",
                "quick_menu_title": "Visit Us",
                ...
                "quick_morning": "Early Morning Service | 6AM (Online)",
                "quick_morning_sub": "",
                "quick_morning_desc1": "1st & 2nd week of month",
                "quick_morning_desc2": "6AM Online Zoom",
                ...
                "past_gallery": "Past Gallery Archive",
                "past_gallery_desc": "Archive of past photos and videos to look back on the graceful moments of the church.",
                "past_columns": "Past Theological column",
            ...
            "about": {
                ...
                "affiliated_orgs_desc_mobile": "The Church of the Sent is affiliated with<br/> the Americas General Assembly of the <br/> Korea Evangelical Holiness Church (KEHC).<br/><br/>The Holiness Church believes in the Triune<br/> God and affirms the Bible as the living <br/> and authoritative Word of God.<br/>We believe that through the death and<br/> resurrection of Jesus Christ we are born<br/> again, that through the work of the <br/> Holy Spirit we are called to live holy and<br/> sanctified lives, that God has the power <br/> to bring healing, and that Jesus Christ <br/> will return again.<br/><br/>In Canada, we are also part of the <br/> Evangelical Free Church of Canada (EFCC),<br/> an evangelical denomination that affirms <br/> the Bible as the final authority for faith<br/> and life.<br/><br/>Within the EFCC, each local church is <br/> self-governing and operates with <br/> a high degree of autonomy. <br/> While we share a common statement of<br/> faith and mission, local congregations are<br/> led by their own leadership and affirmed <br/> by their membership.<br/><br/>Representative educational institutions<br/> connected with the EFCC include Trinity<br/> Western University in British Columbia, <br/> Canada, and Trinity Evangelical Divinity<br/> School (TEDS) in the United States.",
                ...
                "pastor_label": "PASTOR",
                "pastor_title": "Senior Pastor's Greeting",
                "vision_label": "VISION",
                "vision_title": "Vision",
            ...
            "worship": {
                ...
                "dawn_service": "Early Morning Service",
            ...
            "ministry": {
                "subtitle": "Kids/Youth",
                "subtitle_verse": "“Therefore go and make disciples of all nations...” (Matthew 28:19)",
                ...
                "prayer": {
                    ...
                    "intro_desc": "Our church is a community that prays for one another. <br class='hidden md:block' /> We invite you to share your prayer requests below and <br class='hidden md:block' /> join us in prayer wherever you are.<br/><br/><span class='text-blue-800 font-bold'>We believe that as we pray together, <br class='hidden md:block' /> God is at work among us.</span>",
                    ...
                    "section2_title": "Core Values",
                    "section3_title": "Ministry Goals",
            ...
            "resources": {
                ...
                "no_notices": "No announcements found.",
                "latest_notice": "Latest Announcement",
                ...
                "download": "Download",
                "author_prefix": "By: ",
                "daily_word_title": "Verse of the Week",
            ...
            "tee": {
                ...
                "intro_desc_mobile": "TEE stands for Theological Education by Extension.<br/>Rooted in the vision of 2 Timothy 2:2, it is a<br/>discipleship-focused approach to theological<br/>training that extends beyond the classroom and<br/>into everyday life.",
                "intro_subdesc_mobile": "Through Bible study and intentional disciple-making,<br/>TEE helps nurture a faith that can be faithfully passed<br/>on to the next generation. It is a proven and widely<br/>used training model for equipping believers and<br/>developing leaders within the local church.",
                ...
                "core_goal_desc_mobile": "At the heart of TEE is <strong>spiritual multiplication</strong>—one disciple raising up another.<br/>Through small group–based training, believers are strengthened spiritually and equipped to grow into the next generation of leaders within the church.<br/><br/>What begins slowly and modestly can grow into something powerful.",
            ...
            "bible": {
                ...
                "intro_desc": "In this study, we journey through the Gospel of John with <br class='hidden md:block' /> careful attention to its context, movement, and message. <br class='hidden md:block' /> Using Scripture itself as our primary text, we seek to encounter <br class='hidden md:block' /> God’s Word more deeply and build a firm foundation for faith.",
                "intro_desc_mobile": "In this study, we journey through the Gospel<br/> of John with careful attention to its context,<br/> movement, and message. Using Scripture<br/> itself as our primary text, we seek to build a<br/> firm foundation for faith.",
                "theo_diff_title": "The Distinctive Voice of John’s Gospel",
                "theo_diff_text1": "The Synoptic Gospels—Matthew, Mark, and Luke—offer a vivid account of <br class='hidden md:block' /> what Jesus did and what He said. The Gospel of John invites us <br class='hidden md:block' /> to go even deeper, revealing who Jesus truly is <br class='hidden md:block' /> and the profound spiritual meaning of His death and resurrection.",
                "theo_diff_text1_mobile": "The Synoptic Gospels–Matthew, Mark, and<br/> Luke–offer a vivid account of what Jesus<br/> did and said. John’s Gospel invites us to go<br/> even deeper, revealing who Jesus truly is.",
                "theo_diff_text2": "If the Synoptic Gospels present a clear picture of <br class='hidden md:block' /> Jesus’ life and ministry, the Gospel of John brings into focus the depth of <br class='hidden md:block' /> His identity and the significance of His work.",
                "theo_diff_text2_mobile": "If the Synoptic Gospels present a clear<br/> picture of Jesus’ life and ministry, John’s<br/> Gospel brings into focus the depth of His<br/> identity and His work.",
                "theo_diff_text3": "One tells the story as it unfolded in history; <br class='hidden md:block' /> the other draws us into the theological depth behind it.",
                "theo_diff_text3_mobile": "One tells the story as it unfolded in history;<br/> the other draws us into the theological depth<br/> behind it.",
                ...
                "curriculum_subtitle_mobile": "This study follows the core structure of the<br/> Gospel of John in four themes.",
