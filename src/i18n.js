        ...
        translation: {
            ...
            "ministry": {
                ...
                "prayer": {
                    ...
                    "intro_desc": "Our church is a community that prays for one another. <br class='hidden md:block' /> We invite you to share the prayer requests below and <br class='hidden md:block' /> join us in prayer wherever you are.<br/><br/><span class='text-blue-800 font-bold'>We believe that as we pray together, <br class='hidden md:block' /> God is at work among us.</span>",
