                        ...
                        <div className="flex flex-col md:flex-row gap-12 items-start">
                            ...
                            <div className="w-full md:w-7/12">
                                <div className="prose prose-lg text-gray-600 max-w-none">
                                    <p className="mb-2 mt-12 leading-[2.2] whitespace-pre-line text-gray-700 break-keep text-center">
            ...
            <section className="py-24 bg-gray-50/50">
                <div className="container mx-auto px-4 text-center">
                    <p className="text-gray-700 font-bold italic font-sans text-sm md:text-base leading-[2.2] max-w-3xl mx-auto mb-8 break-keep">
                        저희 교회는 <span className="text-primary">"예수교대한성결교회"</span>의 미주 총회에 소속되어 있으며,<br />
