            ...
            <main className="container mx-auto px-6 py-20 max-w-6xl">
                ...
                <div className="mb-20 animate-fade-in-up">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
                        ...
                        <div className="text-left space-y-8">
                            <div className="text-base md:text-lg text-stone-700 leading-[2.8] font-bold break-keep"
                ...
                <div className="max-w-5xl mx-auto px-4 pb-32">
                    <div className="mb-20 text-center">
                        ...
                        <div
                            className="text-base text-stone-500 font-medium leading-[2.8] max-w-2xl mx-auto break-keep"
                                        ...
                                        section.id === 'church' ? (
                                            <div className="space-y-6">
                                                ...
                                                {section.topics.length > 1 && (
                                                    <ol className="list-decimal marker:text-blue-500 marker:font-black pl-5 space-y-4 text-stone-600 font-medium text-base lg:text-lg leading-[2.8]">
