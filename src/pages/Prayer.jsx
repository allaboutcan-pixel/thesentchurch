            ...
            <main className="container mx-auto px-6 py-20 max-w-6xl">
                ...
                <div className="mb-20 animate-fade-in-up">
                    ...
                    <div className="text-center mb-32">
                        ...
                        <h2 className="text-2xl md:text-4xl font-black text-blue-900 leading-[2.5]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
                        ...
                        <div className="text-left space-y-8">
                            <div className="text-lg md:text-xl text-stone-700 leading-[2.5] font-bold break-keep"
                ...
                <div className="max-w-5xl mx-auto px-4 pb-32">
                    <div className="mb-20 text-center">
                        ...
                        <div
                            className="text-lg text-stone-500 font-medium leading-[2.5] max-w-2xl mx-auto break-keep"
                                        ...
                                        section.id === 'church' ? (
                                            <div className="space-y-6">
                                                ...
                                                {section.topics.length > 1 && (
                                                    <ol className="list-decimal marker:text-blue-500 marker:font-black pl-5 space-y-4 text-stone-600 font-medium text-lg lg:text-xl leading-[2.5]">
                                            ...
                                            <ol className={clsx(
                                                "space-y-4 text-stone-600 font-medium text-lg lg:text-xl leading-[2.5] pl-5",
