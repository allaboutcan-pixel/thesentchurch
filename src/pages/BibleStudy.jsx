...
const BibleStudy = () => {
    ...
    const bannerTitle = isEnglish
        ? (siteConfig?.[`${type}TitleEn`] || t('bible.banner_title'))
        : (siteConfig?.[`${type}Title`] || t('bible.banner_title'));

    const bannerSubtitle = isEnglish
        ? (siteConfig?.[`${type}SubtitleEn`] || t('bible.banner_subtitle'))
        : (siteConfig?.[`${type}Subtitle`] || t('bible.banner_subtitle'));
