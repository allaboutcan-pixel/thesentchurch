...
const TEE = () => {
    ...
    const bannerTitle = (isEnglish && siteConfig?.[`${type}TitleEn`]) ? siteConfig[`${type}TitleEn`] : (siteConfig?.[`${type}Title`] || t('tee.banner_title'));
    const bannerSubtitle = (isEnglish && siteConfig?.[`${type}SubtitleEn`]) ? siteConfig[`${type}SubtitleEn`] : (siteConfig?.[`${type}Subtitle`] || t('tee.banner_subtitle'));
                ...
                <div className="container mx-auto px-6 max-w-6xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                        ...
                        >
                            ...
                            <div className="text-slate-700 leading-loose text-lg space-y-4 text-center">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
                        ...
                        >
                            ...
                            <div className="bg-slate-50 p-6 rounded-xl border border-blue-100 mt-auto">
                                <p className="text-sm font-medium text-center text-slate-800 whitespace-pre-line leading-loose italic font-sans md:block hidden">
                                    {t('tee.core_value_box')}
                                </p>
                                <p className="text-sm font-medium text-center text-slate-800 whitespace-pre-line leading-loose italic font-sans md:hidden block" dangerouslySetInnerHTML={{ __html: t('tee.core_value_box_mobile').replace(/\n/g, '<br/>') }} />
                            </div>
            ...
            < section className="py-32 bg-white text-center" >
                <div className="container mx-auto px-6 max-w-3xl">
                    ...
                    >
                        ...
                        <p className="text-sm md:text-xl text-slate-600 leading-[2.5] break-keep font-light">
